...
public class Admin extends DBconnect {
	...
	public boolean login_admin() { // 관리자 로그인
		try {
			...
			if (gMem == null) {
				System.out.println("관리자 아이디 및 비번이 맞지 않습니다\n다시 확인 바랍니다\n");
				return false;
	...
	public void find_admin_id() { // 관리자 아이디 찾기
		try {
			...
			System.out.println("관리자 아이디 찾기 Error : " + ex.getMessage());
		}
	}
	...
	public void find_admin_pw() { // 관리자 비번 찾기
		try {
			...
			System.out.println("관리자 비번 찾기 Error : " + ex.getMessage());
		}
	}
	...
	public void change_admin_pw() { // 관리자 비번 변경
		try {
			...
			System.out.println("관리자 비번 변경 Error : " + ex.getMessage());
		}
	}
	...
	public void del_mv() { // 영화 삭제
		try {
			...
			if (book_confirm(title)) {
				System.out.println("예매 정보가 있습니다.\n영화 정보 삭제 할 수 없습니다.\n");
				return;
			}
